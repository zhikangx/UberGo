        ...
        output$map <- renderLeaflet({
                ...
                leaflet() %>% 
                        ...
                        addEasyButton(easyButton(
                                ...
                                onClick = JS("function(btn, map){ map.setView([40.72465, -73.99539],24);}"))) %>%
                        addEasyButton(easyButton(
                ...
                if(!is.null(input$map_zoom)){
                        if (input$map_zoom >= 15) {
                                ...
                                leafletProxy("map") %>% 
                                        ...
                                        addAwesomeMarkers(data = event_geo, icon = icon.concert, clusterOptions = markerClusterOptions(),
                                        ...
                                        addAwesomeMarkers(data = data_event_other, icon = icon.otherevent, clusterOptions = markerClusterOptions(),
                                        ...
                                        addAwesomeMarkers(data = data_sport_geo, icon = icon.otherevent, clusterOptions = markerClusterOptions(),
