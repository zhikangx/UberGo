server <- function(input, output,session) {
        ...
        output$map <- renderLeaflet({
                ...
                leaflet() %>% 
                        ...
                        # addMarkers(data = pnt) %>%
                        # addCircles(data = pnt, weight = 1,color = "orange", radius = 1000)%>%
                ...
                if(!is.null(input$map_zoom)){
                        if (input$map_zoom >= 15) {
                                ...
                                leafletProxy("map") %>% 
                                        ...
                                        addAwesomeMarkers(data = data_sport_geo, icon = icon.football,
                                        ...
                                        addCircles(data = pickup_in_range(), weight = 7,color = "#00A699", stroke = FALSE, fillOpacity = 0.3, radius = 2*data_pickup_pop$cnt/10) %>% 
                                        addPolylines(data = seg1, opacity = 1, weight = 7, color = "#DC143C") %>% 
                                        addPolylines(data = seg2, opacity = 1, weight = 7, color = "#DC143C") %>% 
                                        addPolylines(data = seg3, opacity = 1, weight = 7, color = "#eeAD10") %>% 
                                        addPolylines(data = seg5, opacity = 1, weight = 7, color = "#eeAD10") %>% 
                                        addPolylines(data = seg4, opacity = 1, weight = 7, color = "#DC143C") 
                                # addMarkers(
                ...
                leaflet(nycounties3) %>%
                        ...
                        addPolygons(layerId= nycounties3$communityDistrict, stroke = TRUE,color = "black", weight = 2, smoothFactor = 1, fillOpacity = 0.6,
                                    ...
                                    labelOptions = labelOptions(
                                            ...
                                            textsize = "15px",
                                            direction = "auto")) %>%
                        addLegend(pal = pal_income, values = ~log10(nycounties3$income), opacity = 0.7, title = NULL,
                                  position = "bottomleft" ) %>%
                        addCircleMarkers(data = current_gps,weight = 10) %>% 
                        addCircleMarkers(data = current_gps, stroke=FALSE, color="white",fill = FALSE, radius = 14) %>% 
                        # setView(lng =current_gps[1], lat =current_gps[2] , zoom = 24) %>%
                        setView(lng =current_gps[1], lat =current_gps[2] , zoom = 13) %>%
                        # addEasyButton(easyButton(
        ...
        output$rides3 <- renderPlot({
                ...
                ggplot(df, aes(x=reorder(area, -rides), rides 
                        ...
                        xlab("Community") + ylab("Number of Rides")
                # 
        ...
        output$income3 <- renderPlot({
                ...
                ggplot(df, aes(x=reorder(area, -income), income)) +
                        geom_col()+
                        xlab("Community") + ylab("Income per Minute")
        })
                ...
                leafletProxy("history",data=nycounties3) %>% 
                        ...
                        addPolygons(stroke = TRUE,color = "black", weight = 2, smoothFactor = 1, fillOpacity = 0.6,
                                    ...
                                    labelOptions = labelOptions(
                                            ...
                                            textsize = "15px",
                                            direction = "auto"))%>%
                        addLegend(pal = pal_rides, values = ~log10(nycounties3$income), opacity = 0.7, title = NULL,
                                  position = "bottomleft" )
        })
                ...
                leafletProxy("history",data=nycounties3) %>% 
                        ...
                        addPolygons(stroke = TRUE,color = "black", weight = 2, smoothFactor = 1, fillOpacity = 0.6,
                                    ...
                                    labelOptions = labelOptions(
                                            ...
                                            textsize = "15px",
                                            direction = "auto"))%>%
                        addLegend(pal = pal_wktime, values = ~log10(nycounties3$income), opacity = 0.7, title = NULL,
                                  position = "bottomleft" )
        })       
